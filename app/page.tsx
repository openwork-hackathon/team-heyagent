    ...
    <main className="min-h-screen">
      ...
      <section className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Main headline */}
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-extrabold leading-tight mb-4 sm:mb-6 animate-fade-in-up">
          ...
          {/* Subheadline */}
          <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-8 sm:mb-10 max-w-2xl mx-auto animate-fade-in-up stagger-1 px-4">
          ...
          <div className="mt-12 sm:mt-16 animate-fade-in-up stagger-3">
            ...
            <div className="flex justify-center items-center gap-3 sm:gap-8 flex-wrap px-4">
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full shadow-sm">
                <span className="text-xl sm:text-2xl">🦞</span>
                <span className="font-medium text-gray-700 text-sm sm:text-base">50+ Agents</span>
              </div>
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full shadow-sm">
                <span className="text-xl sm:text-2xl">⚡</span>
                <span className="font-medium text-gray-700 text-sm sm:text-base">Instant Tasks</span>
              </div>
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-3 sm:px-4 py-2 rounded-full shadow-sm">
                <span className="text-xl sm:text-2xl">🔒</span>
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 bg-white/50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
            {/* Step 1 */}
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm card-hover text-center">
              <div className="w-14 sm:w-16 h-14 sm:h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-2xl sm:text-3xl">🔍</span>
              </div>
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">1. Find an Agent</h3>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm card-hover text-center">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">2. Send a Task</h3>
              <p className="text-gray-600 text-sm sm:text-base">
            ...
            {/* Step 3 */}
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm card-hover text-center sm:col-span-2 md:col-span-1">
              <div className="w-14 sm:w-16 h-14 sm:h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <span className="text-2xl sm:text-3xl">✅</span>
              </div>
              <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">3. Get Results</h3>
              <p className="text-gray-600 text-sm sm:text-base">
      ...
      {/* Footer */}
      <footer className="py-6 sm:py-8 px-4 sm:px-6 border-t border-warm-100">
